...
export function TaskGraphView({ tasks, members, onOpen, onTaskUpdated, onTaskCreated, focusTaskId }: Props) {
  ...
  return (
    <section className="task-graph-view mt-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900" aria-label="Mapa mental de tarefas">
      <div className="task-graph-header mb-4">
        <div className="task-graph-header-copy">
        ...
        <div className="task-graph-toolbar">
          {tasks.length > 0 && <label className="text-xs text-slate-600 dark:text-slate-300">
            Tarefa
      ...
      {!selectedTask ? (
        ...
        <div className="task-graph-canvas rounded-xl border border-slate-200 bg-slate-50/70 dark:border-slate-700 dark:bg-slate-950/40">
          <div className="task-graph-canvas-inner relative" style={{ minWidth: graph.width, minHeight: graph.height }}>
      ...
      <div className="task-graph-footer mt-4 flex flex-wrap items-center justify-between gap-2 text-xs text-slate-500 dark:text-slate-400">
      ...
      {looseNodeOpen && selectedTask && <div className="task-graph-loose-form mt-3 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-950/40">
      ...
      {selectedTask && <div className="task-graph-source mt-4 rounded-xl border border-slate-200 px-3 py-3 text-[11px] text-slate-500 dark:border-slate-700 dark:text-slate-400">
