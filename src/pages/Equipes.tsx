...
export default function Equipes() {
  ...
  return <div className="page-container premium-module-page premium-teams-page" style={{ maxWidth:920 }}>
    <div className="premium-module-header" style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:12, marginBottom:22 }}><div><h1 style={{ fontFamily:'var(--font-heading)', fontWeight:900 }}>{t('teams.pageTitle')}</h1><p style={{ color:'var(--text3)' }}>{t('teams.pageSubtitle')}</p></div><button className="btn btn-primary" onClick={()=>setModal(null)}><Plus size={16}/> Nova equipe</button></div>
