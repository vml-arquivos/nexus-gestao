 ...
 *
 * Localização sugerida: src/pages/Backup.tsx
 *
 * Funcionalidades:
 * - Status do banco (tamanho, versão, tabelas)
 * - Botão de backup manual com download .sql.gz
 * - Histórico de backups realizados na sessão
 *
 * Visível apenas para: admin, dev, gestor (controlado na rota do backend também)
 */
...
export default function Backup() {
  ...
  // Roles permitidos (mesmos do gestorOnly no backend)
  ...
  async function handleDownload() {
    ...
    try {
      // Usa fetch diretamente para capturar o blob de download
      ...
      // Atualiza histórico após download
      ...
      <Card style={{ marginBottom: 16, background: 'var(--info-bg, #1e3a5f22)', borderColor: 'var(--info, #3B82F6)' }}>
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.55 }}>
            ...
            Para restaurar, descompacte o arquivo e execute:{' '}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              <span style={{ fontSize: 13, color: 'var(--text2)' }}>
                📅 {formatDate(s.ultimoBackup.realizadoEm)}
              </span>
              <span style={{ fontSize: 13, color: 'var(--text3)' }}>
                💾 {formatBytes(s.ultimoBackup.tamanhoBytes)}
              </span>
              <span style={{
        ...
        <Card>
          ...
          {!canBackup && (
            <p style={{ fontSize: 12, color: '#EF4444', marginTop: 8, textAlign: 'center' }}>
              Apenas gestor, admin ou dev podem realizar backups.
            </p>
          )}
        </Card>
        ...
        <Card style={{ borderColor: 'var(--warning, #F59E0B)', background: 'var(--warning-bg, #f59e0b11)' }}>
          ...
          <ol style={{ fontSize: 13, color: 'var(--text2)', lineHeight: 1.7, paddingLeft: 18, margin: 0 }}>
            <li>Descompacte o arquivo: <code style={{ background: 'var(--surface2)', padding: '1px 5px', borderRadius: 4, fontSize: 12 }}>gunzip nexus-backup-*.sql.gz</code></li>
            <li>Crie um banco novo (se necessário): <code style={{ background: 'var(--surface2)', padding: '1px 5px', borderRadius: 4, fontSize: 12 }}>createdb nexus_restore</code></li>
