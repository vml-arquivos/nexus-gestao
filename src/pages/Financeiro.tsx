...
function GerenciarDividaModal({ parcelas, tipo, onUpdate, onClose }: {
  ...
  return (
    <div
      style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', zIndex: 300, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', backdropFilter: 'blur(4px)', overflowY: 'auto', padding: 'max(20px, env(safe-area-inset-top, 0px)) 16px 20px' }}
