...
function GerenciarDividaModal({ parcelas, tipo, onUpdate, onClose }: {
  ...
  return (
    <div
      style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', zIndex: 300, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', backdropFilter: 'blur(4px)', overflowY: 'auto', padding: 'max(20px, calc(env(safe-area-inset-top, 0px) + 12px)) 16px max(20px, calc(env(safe-area-inset-bottom, 0px) + 12px))' }}
      onClick={e => e.target === e.currentTarget && onClose()}
    >
      <div style={{ background: 'var(--bg2)', borderRadius: '20px', padding: '24px 20px 32px', width: '100%', maxWidth: 52, margin: '0 auto'0, overflowY: 'auto', margin: '0 auto' }}>
...
function PagamentoModal({ pessoas, onSave, onClose, initial }: {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', zIndex: 200, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', backdropFilter: 'blur(4px)', overflowY: 'auto', padding: 'max(20px, calc(env(safe-area-inset-top, 0px) + 12px)) 16px max(20px, calc(env(safe-area-inset-bottom, 0px) + 12px))' }} onClick={e => e.target === e.currentTarget && onClose()}>
      <div style={{ background: 'var(--bg2)', borderRadius: '20px', padding: '24px 20px 32px', width: '100%', maxWidth: 58, margin: '0 auto'0, overflowY: 'auto', margin: '0 auto' }}>
