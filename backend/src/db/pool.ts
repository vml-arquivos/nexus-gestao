...
// Pool isolado para readiness: não fica atrás da fila de consultas da
// aplicação quando há pico de tarefas/ranking.
...
healthPool.on('error', (err) => {
  console.error('[DB] Erro no pool de healthcheck:', err.message)
})
